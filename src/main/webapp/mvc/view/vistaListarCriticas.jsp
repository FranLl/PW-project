...
%>
	<jsp:forward page="/">
		<jsp:param value="Acceda o reg&iacutestrese" name="message"/>
	</jsp:forward>
<%
}
%>
...
<html>
	<head>
		<meta charset="UTF-8">
		<title>Vista Espectaculos Celebrados</title>
		...
		<link rel="stylesheet" type="text/css" href="/practica3/css/listarPastShows.css">
	</head>
	<body>
		<%
		...
		%>
		<fieldset>
			<legend>Espectáculos celebrados</legend>
		
			<form action="/practica3/publicarcritica" method="POST">
				<p>Conciertos</p>
				<dl>
